...
file_path = 'TCGA_training_data.csv'
directory = ''
project_name = 'TCGA'
layers_range = (2, 6)
...
def model_builder(hp):
  ...
  model.add(keras.layers.Dense(1427, input_dim = 1427, activation = 'relu'))
...
train = pd.read_csv("TCGA_training_data.csv")
X_train = train.iloc[: , 2:-1]
Y_train = train.iloc[: , -1:]
