...
Fig1d. CCLE/GDSC2 data trained models and independent test dataset used for evaluation of Precily based deep neural network model.
Fig1e. CCLE/CTRPv2 data trained models and independent test dataset used for evaluation of Precily based deep neural network model.
